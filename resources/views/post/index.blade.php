...
<h1 class="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Data</span> Post in a Week.</h1>
        ...
        @foreach ($post as $post)
            ...
            <script>
                function openModal(postId) {
                    // Mengatur action form dengan ID post yang dipilih
                    const form = document.getElementById('deleteForm');
                    form.action = `/posts/${postId}`; // Ganti dengan route yang sesuai jika berbeda
